	...
	<HEAD>
		...
		function changetype(){
		  ...
		  if(document.Form1.keyword.value=="jerrynew"){
		     ...
		     Pub.submitActionWithForm('Form2','<%=path%>/systemAction?action_flag=edit','Form1');
     ...
     function saveDict(){
	      ...
	      if(document.Form1.keyword.value=="jerrynew"){
	         ...
	         for(var i=0;i<allkeywords.length;i++){
	          ...
	          document.Form2.typeflag.value="addsave";
	          
	      }else{
	      
	          document.Form2.keywordname.value=document.Form1.keyword.value;
	          document.Form2.typeflag.value="updatesave";	
	      }
		  ...
		  alert("保存或修改成功");
	      document.Form2.action="<%=path%>/systemAction?action_flag=save";
 ...
 function insertRows(){ 
  ...
  { 
    ...
    { 
      ...
      case 2 : newCell.innerHTML="<td class=\"ta_01\" align=\"center\"  width=\"25%\"><a href='javascript:delTableRow(\""+tempRow+"\")'><img src=<%=path%>/images/delete.gif width=15 height=14 border=0 style=CURSOR:hand></a></td>";break;
...
function delTableRow(rowNum){ 
   ...
   //   {
     ...
     //    tbl.rows[i].cells[2].innerHTML="<a href='javascript:delTableRow(\""+i+"\")'><img src=<%=path%>/images/delete.gif width=15 height=14 border=0 style=CURSOR:hand></a>";      
     // }
  // }
} 
	...
	<body>
	 <form name="Form1" id="Form1"  method="post" style="margin:0px;">
		<table cellSpacing="1" cellPadding="0" width="90%" align="center" bgColor="#f5fafe" border="0">
			<TBODY>
				<tr>
					<td class="ta_01" colspan=3 align="center" background="<%=path%>/images/b-info.gif">
						<font face="宋体" size="2"><strong>数据字典</strong></font>
					</td>
				</tr>
				...
				<tr>
					...
					<select id="keyword" name="keyword"  style="width:180px" class="bg" onchange="changetype()">
					   <option value="jerrynew"></option>
					<c:forEach items="${systemddls}" var="sys" varStatus="keyword">
						<option value="${sys.keyword}">${sys.keyword}</option>
					</c:forEach>
					</select>
					</td>
	   ...
	   <table cellspacing="0"   cellpadding="1" rules="all" bordercolor="gray" border="1" id="dictTbl"
		    style="BORDER-RIGHT:gray 1px solid; BORDER-TOP:gray 1px solid; BORDER-LEFT:gray 1px solid; WIDTH:100%; WORD-BREAK:break-all; BORDER-BOTTOM:gray 1px solid; BORDER-COLLAPSE:collapse; BACKGROUND-COLOR:#f5fafe; WORD-WRAP:break-word">
				...
				<tr style="FONT-WEIGHT:bold;FONT-SIZE:12pt;HEIGHT:25px;BACKGROUND-COLOR:#afd1f3">
					<td class="ta_01" align="center"  width="20%" height=22 background="<%=path%>/images/tablehead.jpg">编号</td>
					<td class="ta_01" align="center"  width="60%" height=22 background="<%=path%>/images/tablehead.jpg">名称</td>
					<td class="ta_01" align="center"  width="20%" height=22 background="<%=path%>/images/tablehead.jpg">删除</td>					
				</tr>
