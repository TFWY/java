...
th.action="<%=path%>/classAction?action_flag=dels&ids="+getSelectValue();
th.submit();
}
...
function getSelectValue()
{
  ...
  function checkchar(){
  //alert(11);
  	document.Form1.action="<%=path%>/classAction?action_flag=show";
  	document.Form1.submit();
  }
  //首页
  function first()
  {
  document.Form2.action="<%=path%>/classAction?action_flag=show&pageNum=1";
  document.Form2.submit();
  }
    //上一页
  function forwrad2()
  {
  document.Form2.action="<%=path%>/classAction?action_flag=show&pageNum=<%=pageBean.getCurrentPage()-1%>";
  document.Form2.submit();
  }
   //下一页
  function next()
  ...
  function end()
  {
  document.Form2.action="<%=path%>/classAction?action_flag=show&pageNum=<%=pageBean.getPageCount()%>";
  document.Form2.submit();
  }
			...
			<table cellspacing="1" cellpadding="0" width="90%" align="center" bgcolor="#f5fafe" border="0">
				...
				<tr>
					<td class="ta_01" colspan=2 align="center" background="../images/b-info.gif">
						<font face="宋体" size="2"><strong>班次信息管理</strong></font>
					</td>
				...
				<tr>
					...
					班次号：</td>
					<td class="ta_01" >
					<input name="classId" type="text" id="classId"  size="21"><font face="宋体" color="red">
					</font></td>
				</tr>
		    </table>	
		</form>
			...
			<TBODY>
				...
				<tr>
				  	<td>
		                <TABLE style="WIDTH: 105px; HEIGHT: 20px" border="0">
										<TR>
											...
											<TD class="DropShadow" background="<%=path%>/images/cotNavGround.gif">班次列表</TD>
										</TR>
			             </TABLE>
                   </td>
					<td class="ta_01" align="right">
						...
						<input style="font-size:12px; color:black; height=20;width=80" id="BT_Add" type="button" value="添加班次" name="BT_Add" 
						 onclick="openWindow('<%=path%>/classAction?action_flag=showadd','700','400')">
					</td>
				</tr>
				...
				<td class="ta_01" align="center" bgColor="#f5fafe" colspan=3>			
						...
						<table cellspacing="0" cellpadding="1" rules="all" bordercolor="gray" border="1" id="DataGrid1"
							...
							<tr style="FONT-WEIGHT:bold;FONT-SIZE:12pt;HEIGHT:25px;BACKGROUND-COLOR:#afd1f3">
								...
								<td align="center" width="15%" height=22 background="<%=path%>/images/tablehead.jpg">班次号</td>
								<td align="center" width="15%" height=22 background="<%=path%>/images/tablehead.jpg">班次名</td>
								<td align="center" width="10%" height=22 background="<%=path%>/images/tablehead.jpg">班次时间</td>
								<td align="center" width="20%" height=22 background="<%=path%>/images/tablehead.jpg">班次内容</td>
								...
								<c:if test="${classInf!=null}">
								<c:forEach items="${classInf}" var="Inf">
									<tr onmouseover="this.style.backgroundColor = 'white'" onmouseout="this.style.backgroundColor = '#F5FAFE';">
										...
										<td align="center" style="HEIGHT: 22px" align="center" width="5%">																	
										   <a href="#" onclick="openWindow('<%=path%>/classAction?action_flag=edit&editId=${Inf.id}','700','400');">
										   <img src="<%=path%>/images/edit.gif" border="0" style="CURSOR:hand"></a>													
										</td>
										
										<td align="center" style="HEIGHT: 22px" align="center" width="5%">
											<a href="<%=path%>/classAction?action_flag=del&delId=${Inf.id}" onclick="return confirm('你确定要删除吗？')">
