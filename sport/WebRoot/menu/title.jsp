...
<table border="0" width="100%" height="9" cellspacing="0" cellpadding="0">
  <tr>
    <td width="100%" colspan="4" background="<%=path%>/images/title.jpg" height="58">　</td>
  </tr>
  <tr>
    <td width="100%" height="1" bgcolor="#66C89C" colspan="4"><img border="0" src="<%=path%>/images/titleline.jpg" width="100%" height="3"></td>
  </tr>
  <tr>
    ...
    <b><font color="#FFFFFF">欢迎您!&nbsp;&nbsp;&nbsp;<%=username %></font></b>
    </td></tr></table>
    </td>
    ...
    <td width="18%" height="19" bgcolor="#0965CA" align="center">
      <table border="0" width="100%" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <A href="<%=path %>/menu/loading.jsp" target="mainFrame"><font color="#FFFFFF"><b>返回首页</b></font></a>
          <font color="#FFFFFF"><b>|</b></font>
          <A href="<%=path %>/index.jsp"   target="_top"> <font color="#FFFFFF"><b>重新登录</b></font></A>
          <font color="#FFFFFF"><b>|</b></font>
